...
#define FALSE               0
////////////////
#define RF433_CS_UP	   PORTB |= (1 << 4);
#define RF433_CS_DN    PORTB &= ~(1 << 4);
#define RF433_SPCK_UP	PORTB |= (1 << PB7);
#define RF433_SPCK_DN	PORTB &= ~(1 << PB7);

//#define RF433_MISO ((AT91F_PIO_GetInput(AT91C_BASE_PIOA)& (AT91C_PIO_PA27))==(AT91C_PIO_PA27))//0x00010000
#define RF433_MISO   (PINB & (1 << PB6) )

#define RF433_MOSI_UP	PORTB |= (1 << PB5); 
#define RF433_MOSI_DN   PORTB &= ~(1 << PB5);
